...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NickyHu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个好运的80后', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.liwuli.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '投资，代码，开源', // 网站关键词 英文逗号隔开
